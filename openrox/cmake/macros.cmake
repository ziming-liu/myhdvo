MESSAGE(STATUS "\n_____ openrox/cmake/macros.cmake ____________________________________________\n" )
...
macro(add_demo_macro name cxxType)
   ...
   #add_library(${name} SHARED ${sourcename} ${OPENROX_EXAMPLES_EXTERNAL_SOURCES})

   message("add lib source :" ${sourcename})
   ...
   #     PUBLIC
   #     ${OPENROX_EXAMPLES_EXTERNAL_SOURCES}
   #     )
