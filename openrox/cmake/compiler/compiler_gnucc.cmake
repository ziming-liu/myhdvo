MESSAGE(STATUS "\n_____ openrox/cmake/compiler_gnucc.cmake ____________________________________________\n" )
...
elseif (OPENROX_HAS_NEON_SUPPORT AND ${PROJECT_NAME}_CREATE_PLATFORM_OPTIMIZED)
  ...
  if (OPENROX_IS_IOS)
   ...
   if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64|ARM64)")
      # ARM64/AArch64 - NEON is built-in, no special flags needed
      MESSAGE(STATUS "Configuring for ARM64 with NEON support")
      # Optional: target specific CPU if known
      # list(APPEND ${PROJECT_NAME}_LOCAL_CMAKE_C_FLAGS "-mcpu=native")
   elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(arm|ARM)")
      # ARM32 - need explicit NEON flags
      MESSAGE(STATUS "Configuring for ARM32 with NEON support")
