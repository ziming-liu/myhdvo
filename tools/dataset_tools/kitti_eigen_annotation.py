            ...
            if left_img_path in raw_imgid_to_odom_imgid:
                ...
                if pre_flag == 1:
                    ...
                    gt_poses = [ gtpose_ann[odom_seqid][odom_imgid-1],
                                            gtpose_ann[odom_seqid][odom_imgid] ]
                    image_2_paths = [os.path.join(data_prefix, left_img_path.replace(cur_id,last_id)), os.path.join(data_prefix, left_img_path)]
                    image_3_paths = [os.path.join(data_prefix, right_img_path.replace(cur_id,last_id)), os.path.join(data_prefix, right_img_path)]
                    dict_i = dict(
