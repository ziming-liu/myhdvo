...
train_pipeline = [
    ...
    dict(type='PhotoMetricDistortionDifferent'),
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=[
                   # "/home/ziliu/mydata/kittistereo2015/annotations/split_test.json",\
                     "/home/ziliu/mydata/kittistereo2012/annotations/split_test.json"  
                     ] ,
        #end_id=100,
        data_prefix=[
