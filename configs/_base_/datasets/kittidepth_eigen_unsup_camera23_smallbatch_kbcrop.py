...
train_pipeline = [
    ...
    dict(type='KITTIKBCrop', keys=['left_imgs', 'right_imgs', ],crop_size=[352,1216]), #crop_size=[256,1216]),
...
val_pipeline = [
    ...
    dict(type='KITTIKBCrop', keys=['left_imgs', 'right_imgs', ],crop_size=[352,1216]), #crop_size=[256,1216]), #crop_size=[256,1216]),
