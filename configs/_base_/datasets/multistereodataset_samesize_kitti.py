...
train_pipeline = [
    ...
    dict(type='KITTIKBCrop', keys=['left_imgs', 'right_imgs', 'left_disps', 'right_disps'], crop_size=320),
    ...
    dict(type='Collect', keys=['left_imgs','right_imgs', 'left_disps', 'right_disps', 'focal', 'baseline' ], meta_keys=[  ]),
    dict(type='ToTensor', keys=['left_imgs','right_imgs', 'left_disps',   'right_disps', 'focal', 'baseline' ])
]
val_pipeline = [
    dict(type='LoadStereoImages', to_float32=False,
                 color_type='color',
...
data = dict(
    ...
    train=dict(
        ...
        data_prefix=[ #"/home/ziliu/mydata/drivingstereo", "/home/ziliu/mydata/drivingstereo", 
                     "/home/ziliu/mydata", "/home/ziliu/mydata", \
