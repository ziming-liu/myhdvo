...
LastEditTime: 2023-04-18 02:48:18
'''
...
train_pipeline = [
    ...
    #                        scale_max=1.0,
    #                        seed=0,),
    dict(type='FlowAugmentor', crop_size=crop_size, min_scale=-0.2, max_scale=0.4, do_flip=False, yjitter=True, saturation_range=[0,1.4], gamma=[1,1,1,1]),
