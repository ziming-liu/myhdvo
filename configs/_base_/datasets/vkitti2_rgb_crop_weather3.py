...
data = dict(
    ...
    train=dict(
        ...
        ann_files=[
            # Clone weather
            osp.join(annfile_root, "weather3/clone/scene01.json"),
            osp.join(annfile_root, "weather3/clone/scene02.json"),
            osp.join(annfile_root, "weather3/clone/scene18.json"),
            # Fog weather
            osp.join(annfile_root, "weather3/fog/scene01.json"),
            osp.join(annfile_root, "weather3/fog/scene02.json"),
            osp.join(annfile_root, "weather3/fog/scene18.json"),
            # Morning weather
            osp.join(annfile_root, "weather3/morning/scene01.json"),
            osp.join(annfile_root, "weather3/morning/scene02.json"),
            osp.join(annfile_root, "weather3/morning/scene18.json"),
            # Overcast weather
            osp.join(annfile_root, "weather3/overcast/scene01.json"),
            osp.join(annfile_root, "weather3/overcast/scene02.json"),
            osp.join(annfile_root, "weather3/overcast/scene18.json"),
            # Rain weather
            osp.join(annfile_root, "weather3/rain/scene01.json"),
            osp.join(annfile_root, "weather3/rain/scene02.json"),
            osp.join(annfile_root, "weather3/rain/scene18.json"),
            # Sunset weather
            osp.join(annfile_root, "weather3/sunset/scene01.json"),
            osp.join(annfile_root, "weather3/sunset/scene02.json"),
            osp.join(annfile_root, "weather3/sunset/scene18.json"),
        ],
    ...
    test=dict(
        ...
        test_sequences=[
            ...
            # ),
            dict(
                ann_file=osp.join(annfile_root, "weather/fog/scene01.json"),
                test_seq_id="Scene01_fog",
                scene="Scene01",
                variation="fog"
            ),
            # Morning weather
            ...
            # ),
            dict(
                ann_file=osp.join(annfile_root, "weather/morning/scene01.json"),
                test_seq_id="Scene01_morning",
                scene="Scene01",
                variation="morning"
            ),
            # Overcast weather
            ...
            # ),
            dict(
                ann_file=osp.join(annfile_root, "weather/overcast/scene01.json"),
                test_seq_id="Scene01_overcast",
                scene="Scene01",
                variation="overcast"
            ),
            # Rain weather
            ...
            # ),
            dict(
                ann_file=osp.join(annfile_root, "weather/rain/scene01.json"),
                test_seq_id="Scene01_rain",
                scene="Scene01",
                variation="rain"
            ),
            # Sunset weather
            ...
            # ),
            dict(
                ann_file=osp.join(annfile_root, "weather/sunset/scene01.json"),
                test_seq_id="Scene01_sunset",
                scene="Scene01",
                variation="sunset"
            ),
        ]
