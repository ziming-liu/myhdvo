...
LastEditTime: 2023-03-30 15:17:05
...
model=dict( 
        ...
        mono_head=None,
        stereo_init_head = dict(type="PSMNetHead48Uni",
            in_channels=[64*2], 
            ############################################
        ...
        disp_head=[dict(type="PyramidStereoHead2AdabinDeltaUni", # use disp attne conv layer
            in_channels=[64*2], 
            adabins="pixel-wise",
            if_adabins=False,
            latent_dims=32,
        ...
        dict(type="PyramidStereoHead2AdabinDeltaUni", # use disp attne conv layer
            in_channels=[64*2], 
            adabins="pixel-wise",
            if_adabins=False,
            latent_dims=32,
...
work_dir = "work_dirs/pyramid_base_setting_cascade8convnext_SFx4size_uni"
#resume_from = "work_dirs/pyramid_base_setting_cascade8convnext_SFx4size_uni/iter_14000.pth"
