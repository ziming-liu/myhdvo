...
###
 ...
 # @LastEditTime: 2023-03-28 12:40:12
 # @Description: ...
...
#OAR --name  pyramid_base_setting_cascade8oneSF200k10iters3
...
OMP_NUM_THREADS=12 torchrun --standalone --nnodes=1 --nproc_per_node=2 \
    tools/train.py configs/pyramid_stereo/pyramid_base_setting_cascade8oneSF200k10iters3.py \
      --launcher pytorch  --validate
 
torchrun --standalone --nnodes=1 --nproc_per_node=2 --master_port=12200 \
  tools/test.py configs/pyramid_stereo/pyramid_base_setting_cascade8oneSF200k10iters3.py \
   work_dirs/pyramid_base_setting_cascade8oneSF200k10iters3/iter_48000.pth   \
