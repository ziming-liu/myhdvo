...
LastEditTime: 2023-03-30 00:58:15
...
model=dict( 
        ...
        disp_head=[dict(type="PyramidStereoHead2AdabinDelta", # use disp attne conv layer
            ...
            losses=dict(
                ...
                weight=1,
                # weights for different scale loss
                weights= [ 1.06 ** (i+1) for i in range(0, iters)], # [  0.9 ** (2*iters - i - 1) for i in range(0, 2*iters)],
                sparse=False,
                set_range=True,
                random_mask = False, 
                random_mask_ratio = 0.5,
...
work_dir = "work_dirs/pyramid_base_setting_cascade8convnext_SFx4size12iters"
#resume_from = "work_dirs/pyramid_base_setting_cascade8convnext_SFx4size12iters/iter_14000.pth"
