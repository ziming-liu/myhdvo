...
LastEditTime: 2023-03-21 17:54:55
'''
...
model=dict( 
        ...
        disp_head=dict(type="PyramidStereoHead2AdabinLightConv", # use disp attne conv layer
            in_channels=[128], 
            adabins="pixel-wise",
            latent_dims=64,
            ############################################
...
work_dir = "work_dirs/pyramid_base_setting_cascade_lightconv2"
