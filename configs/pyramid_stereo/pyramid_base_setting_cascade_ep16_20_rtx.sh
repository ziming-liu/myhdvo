...
###
 ...
 # @LastEditTime: 2023-03-23 11:16:04
 # @Description: ...
...
NCCL_IB_DISABLE=1   python -m torch.distributed.launch --nproc_per_node=3 \
 --master_port=16773     tools/train.py configs/pyramid_stereo/pyramid_base_setting_cascade_ep16_20.py \
     --launcher pytorch  --validate
...
NCCL_IB_DISABLE=1  python -m torch.distributed.launch --nproc_per_node=3 --master_port=12200 \
  tools/test.py configs/pyramid_stereo/pyramid_base_setting_cascade_ep16_20.py \
   work_dirs/pyramid_base_setting_cascade_ep16_20/epoch_16.pth   \
