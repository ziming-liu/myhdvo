...
LastEditTime: 2023-03-15 13:43:18
'''
_base_ = [
    '../_base_/models/pyramid_stereo2_1monos.py',
    '../_base_/datasets/crestereo_random512x512.py', '../_base_/default_runtime.py',
...
work_dir = 'work_dirs/pyramid_stereo_base_weightedloss_smallrange_credata512x512'

resume_from =  'work_dirs/pyramid_stereo_base_weightedloss_smallrange_credata512x512/epoch_15.pth'
