...
LastEditTime: 2023-03-23 17:44:25
'''
...
iters = 10
model=dict( 
        type="PyramidStereoSceneFlow2_1MonosLeft5",
        in_channels=192,
        mask_size=4,
        search_ranges=[4,4,4],
        iters=iters,
...
work_dir = "work_dirs/pyramid_base_setting_cascade51"


# optimizer
optimizer = dict(type='Adam', lr=1.2e-4, betas=(0.9, 0.999), )
