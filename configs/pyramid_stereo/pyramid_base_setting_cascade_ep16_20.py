...
LastEditTime: 2023-03-23 17:13:20
'''
...
work_dir = "work_dirs/pyramid_base_setting_cascade_ep16_20"
resume_from =  "work_dirs/pyramid_base_setting_cascade_ep16_20/epoch_17.pth"
...
optimizer_config = dict(type="GradientCumulativeOptimizerHook", cumulative_iters=4,  
                        grad_clip=None )
# learning policy
lr_config = dict(policy="step", step=[10,12,14,16,18], gamma=1/2,)
# runtime settings
