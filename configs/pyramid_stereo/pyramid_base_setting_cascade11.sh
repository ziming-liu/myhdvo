...
###
 ...
 # @LastEditTime: 2023-03-22 23:55:17
 # @Description: ...
...
#    tools/train.py configs/pyramid_stereo/pyramid_base_setting_cascade11.py \
#      --launcher pytorch  --validate
# Any arguments from the third one are captured by ${@:3}

torchrun --standalone --nnodes=1 --nproc_per_node=3 --master_port=12200 \
  tools/test.py configs/pyramid_stereo/pyramid_base_setting_cascade11.py \
   work_dirs/pyramid_base_setting_cascade11/epoch_16.pth   \
