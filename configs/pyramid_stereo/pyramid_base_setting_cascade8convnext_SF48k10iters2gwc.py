...
LastEditTime: 2023-03-29 22:43:36
...
model=dict( 
        ...
        mono_head=None,
        stereo_init_head = dict(type="GWCNetHead",
            in_channels=[64*2], 
        ...
        disp_head=[dict(type="PyramidStereoGWCHead2AdabinDelta", # use disp attne conv layer
            in_channels=[64*2], 
            gwc_num_groups=32, cat_channels=64,
            adabins="pixel-wise",
            if_adabins=False,
        ...
        dict(type="PyramidStereoGWCHead2AdabinDelta", # use disp attne conv layer
            in_channels=[64*2], 
            gwc_num_groups=32, cat_channels=64,
            adabins="pixel-wise",
            if_adabins=False,
...
work_dir = "work_dirs/pyramid_base_setting_cascade8convnext_SF48k10iters2gwc"
#resume_from = "work_dirs/pyramid_base_setting_cascade8convnext_SF48k10iters2gwc/iter_14000.pth"
