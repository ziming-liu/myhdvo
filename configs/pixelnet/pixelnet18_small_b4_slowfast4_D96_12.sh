...
###
 ...
 # @LastEditTime: 2023-04-18 15:31:20
 # @Description: ...
...
#OAR --name  pixelnet18_small_b4_slowfast4_D96_12
...
#PYTHONPATH="$(dirname $0)/..":$PYTHONPATH \
 OMP_NUM_THREADS=12 torchrun --standalone --nnodes=1 --nproc_per_node=2   \
    tools/train.py configs/pixelnet/pixelnet18_small_b4_slowfast4_D96_12.py \
      --launcher pytorch  --validate
# Any arguments from the third one are captured by ${@:3}

OMP_NUM_THREADS=12 torchrun --standalone --nnodes=1 --nproc_per_node=2 --master_port=12200 \
  tools/test.py configs/pixelnet/pixelnet18_small_b4_slowfast4_D96_12.py \
   work_dirs/pixelnet18_small_b4_slowfast4_D96_12/iter_48000.pth   \
