...
LastEditTime: 2023-04-11 01:04:05
'''
_base_ = [
...
model=dict( 
        ...
        sample_rate=4, 
        dense_channels=32, sparse_channels=256, max_disp=max_disp,
        mask_left=False,
        pretrained="https://download.openmmlab.com/mmaction/recognition/slowfast/slowfast_r101_8x8x1_256e_kinetics400_rgb/slowfast_r101_8x8x1_256e_kinetics400_rgb_20210218-0dd54025.pth",
        backbone=dict(
...
work_dir = 'work_dirs/pixelnet101_small_batch4_slowfast4_videopretrain'
