...
LastEditTime: 2023-04-08 01:20:02
'''
_base_ = [
...
max_disp = 192
model=dict( 
        type="PixelNetSlowFast",
        sample_rate=1, 
        dense_channels=8, sparse_channels=64, cat_disp=192+24, max_disp=192,
        mask_left=False,
        backbone=dict(
...
work_dir = 'work_dirs/pixelnet18_small_b4_slowfast'
resume_from = 'work_dirs/pixelnet18_small_b4_slowfast/iter_28000.pth'