...
LastEditTime: 2023-04-11 23:54:29
'''
_base_ = [
...
model=dict( 
        ...
        sample_rate=2, 
        dense_channels=8, sparse_channels=64, cat_disp=192//2+48, max_disp=192,
        mask_left=False,
        backbone=dict(
...
work_dir = 'work_dirs/pixelnet18_small_b4_slowfast4_192x48'
