...
LastEditTime: 2023-08-16 13:29:37
Description: ...
...
class MonoDepth2(BaseMono):
    def __init__(self, backbone, disp_head, smooth_loss=None,
                  pretrained=None, pred_format="left_depths", pred_format_eval=None,
                    **kwargs):
        super().__init__(backbone, disp_head, None, pretrained, **kwargs)
