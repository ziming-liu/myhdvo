...
class BasicMotionEncoder(nn.Module):
    def __init__(self, args, volume_channel=8):
        super(BasicMotionEncoder, self).__init__()
        self.args = args
        cor_planes = args.corr_levels * (2*args.corr_radius + 1) * (volume_channel+1)
...
class BasicMultiUpdateBlock(nn.Module):
    def __init__(self, args, hidden_dims=[],volume_channel=8):
        super().__init__()
        self.args = args
        self.encoder = BasicMotionEncoder(args, volume_channel)
