...
Author: Ziming Liu
Date: 2023-03-16 11:25:38
LastEditors: Ziming Liu
LastEditTime: 2024-01-14 15:08:06
'''
import torch
...
def inverse_warp_3d(img, disp, padding_mode='zeros', disp_Y=None):
    ...
    D = torch.FloatTensor([D]).type_as(grid_d)
    H = torch.FloatTensor([H]).type_as(grid_h)
    W = torch.FloatTensor([W]).type_as(grid_w)
