...
import fc_grid_sample as gridsample_fc
...
#gridsample_fc = load(name='gridsample_fc', sources=['hdvo/models/utils/fc_grid_sample/fc_grid_sample/fc_grid_sample_cuda.cpp', 'hdvo/models/utils/fc_grid_sample/fc_grid_sample/fc_grid_sample_kernel.cu'], verbose=True)

def grid_sample_2d_fc(input, grid, gt_map, padding_mode='zeros', align_corners=True):
...
class _GridSample2dBackward(torch.autograd.Function):
    ...
    def forward(ctx, grad_output, input, grid, gt_map, output, padding_mode=0, align_corners=True):
        ...
        grad_input, grad_grid = gridsample_fc.grad2_2d_fc(grad_output, input, grid, gt_map, output, \
