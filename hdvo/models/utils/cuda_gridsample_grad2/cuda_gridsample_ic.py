...
import ic_grid_sample as gridsample_ic
...
#gridsample_ic = load(name='gridsample_ic', sources=['hdvo/models/utils/ic_grid_sample/ic_grid_sample/ic_grid_sample_cuda.cpp', 'hdvo/models/utils/ic_grid_sample/ic_grid_sample/ic_grid_sample_kernel.cu'], verbose=True)

def grid_sample_2d_ic(input, grid, gt_map, padding_mode='zeros', align_corners=True):
...
class _GridSample2dBackward(torch.autograd.Function):
    ...
    def forward(ctx, grad_output, input, grid, gt_map, output, padding_mode=0, align_corners=True):
        ...
        grad_input, grad_grid = gridsample_ic.grad2_2d_ic(grad_output, input, grid, gt_map, output, \
