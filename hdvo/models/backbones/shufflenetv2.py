...
class ShuffleNetV2_3d(nn.Module):
    def __init__(self, in_channels=3,  width_mult=1.):
        super(ShuffleNetV2_3d, self).__init__()
        ...
        if width_mult == 0.25:
            self.stage_out_channels = [-1, 24//4,  32//4,  64//4, 128//4,]# 1024]
        elif width_mult == 0.5:
