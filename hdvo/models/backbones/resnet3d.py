...
class ResNet3dLayer(nn.Module):
    ...
    def __init__(self,
        ...
        planes = self.base_channels * 2**stage
        inplanes = self.base_channels * 2**(stage - 1) * block.expansion
...
@BACKBONES.register_module()
class MyResNet3dLayer(nn.Module):
    """ResNet 3d Layer.
