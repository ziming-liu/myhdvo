...
class SqueezeNet3d(nn.Module):
    ...
    def __init__(self,
        ...
        if version == 1.1:
            self.features = nn.ModuleList([
                nn.Conv3d(in_channels, 64//4, kernel_size=3, stride=(1,2,2), padding=(1,1,1)),
                nn.BatchNorm3d(64//4),
                nn.ReLU(inplace=True),
                nn.MaxPool3d(kernel_size=3, stride=2, padding=1),
                Fire(64//4, 16//4, 64//4, 64//4),
                Fire(128//4, 16//4, 64//4, 64//4, use_bypass=True),
                nn.MaxPool3d(kernel_size=3, stride=2, padding=1),
                Fire(128//4, 32//4, 128//4, 128//4),
                Fire(256//4, 32//4, 128//4, 128//4, use_bypass=True),
                nn.MaxPool3d(kernel_size=3, stride=2, padding=1),
                Fire(256//4, 48//4, 192//4, 192//4),
                Fire(384//4, 48//4, 192//4, 192//4, use_bypass=True),
                nn.MaxPool3d(kernel_size=3, stride=2, padding=1),
                Fire(384//4, 64//4, 256//4, 256//4),
                Fire(512//4, 64//4, 256//4, 256//4, use_bypass=True),]
            )
