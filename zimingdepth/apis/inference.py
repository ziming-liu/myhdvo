...
from zimingdepth.core import OutputHook
from zimingdepth.datasets.pipelines import Compose
from zimingdepth.models import  build_stereo_predictor
...
def init_recognizer(config,
    ...
    model =  build_stereo_predictor(config.model, test_cfg=config.get('test_cfg'))
