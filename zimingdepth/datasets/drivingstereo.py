...
LastEditTime: 2023-03-15 01:10:50
'''
...
from zimingdepth.utils import register_module_hooks, get_root_logger
import mmcv 
...
class DrivingStereoDataset(BaseDataset):
    def __init__(self, ann_file, pipeline, data_prefix=None, test_mode=False, end_id=-1,depth_scale_ratio=256,
                 eval_modality='disparity', eval_range=[1,192], filename_tmpl='{:0>43}.jpg',
                   d_filename_tmpl='{:0>43}.png', **kwargs):
