...
LastEditTime: 2023-03-16 11:31:37
Description: ...
...
class FasterSoftArgmin(nn.Module):
    ...
    def __init__(self, max_disp, start_disp=0, dilation=1, alpha=1.0, scale=1.0, normalize=True):
        ...
        self.scale = scale # re-scale the prediction disparity values. e.g. 1--> 10 
        self.alpha = alpha
    ...
    def forward(self, cost_volume, disp_sample=None):
        ...
        #print("prob volum >. ",prob_volume.s)
