...
class PyramidStereoHead2AdabinDeltaUni(nn.Module):
    ...
    losses=None, learn_resize=None, detach_mono_grad=False,  mask_size=4, if_adabins=True,
      adabins='pixel-wise', **kwargs):
        ...
        return: {*}
        '''        
        super(PyramidStereoHead2AdabinDeltaUni, self).__init__()
...
@HEADS.register_module()
class PyramidStereoHead2AdabinDeltaUniLargeRange(PyramidStereoHead2AdabinDeltaUni):
