...
LastEditors: Ziming
LastEditTime: 2023-01-23 04:12:58
Description: ...
...
from zimingdepth.models.backbones.psmnet_base  import conv3d_bn, conv3d_bn_relu, conv_bn_relu, deconv3d_bn


class Hourglass1D(nn.Module):
    """
    ...
    def __init__(self, in_planes, batch_norm=True):
        super(Hourglass1D, self).__init__()
