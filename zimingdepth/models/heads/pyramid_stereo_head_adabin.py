...
class PyramidStereoHead2Adabin(nn.Module):
    def __init__(self, in_channels, max_disp, alpha, normalize, latent_dims=128, 
    losses=None, learn_resize=None, detach_mono_grad=False,  mask_size=4, adabins='pixel-wise', **kwargs):
        '''
        description: 
        return: {*}
        '''        
        super(PyramidStereoHead2Adabin, self).__init__()
...
@HEADS.register_module()
class PyramidStereoHead2AdabinLargeRange(PyramidStereoHead2Adabin):
