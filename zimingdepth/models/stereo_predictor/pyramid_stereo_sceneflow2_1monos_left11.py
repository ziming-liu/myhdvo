...
LastEditTime: 2023-03-30 20:00:32
...
class PyramidStereoSceneFlow2_1MonosLeft11(nn.Module):
    """
    Base depth method. 
    ...
    def __init__(self, backbone, neck, disp_head, mono_head, max_disp, mono_in_channels,
      ...
      iters=4, **kwargs):
        ...
        """
        super(PyramidStereoSceneFlow2_1MonosLeft11, self).__init__()
    ...
    def extract_disp(self, left_img, right_img, **kwargs):
        ...
        if self.stereo_init_head is not None:
            ...
            scale = latent_feats[-3].shape[-1] / disp_init[0].shape[-1]
        ...
        if self.mono_head is not None:
            ...
            scale = latent_feats[-3].shape[-1] / mono_disp.shape[-1]
    ...
    def forward_train(self, left_imgs, right_imgs, **kwargs):
        ...
        if self.mono_head is not None:
            ...
            # stereo loss
            loss_stereo = self.disp_head3.loss(stereo_disp, kwargs["left_disps"])
