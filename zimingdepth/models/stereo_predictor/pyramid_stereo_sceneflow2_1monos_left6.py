...
LastEditTime: 2023-03-24 09:45:06
...
class PyramidStereoSceneFlow2_1MonosLeft6(nn.Module):
    """
    Base depth method. 
    ...
    def __init__(self, backbone, neck, disp_head, mono_head, max_disp, in_channels=128,
      ...
      iters=4, **kwargs):
        ...
        """
        super(PyramidStereoSceneFlow2_1MonosLeft6, self).__init__()
    ...
    def extract_disp(self, left_img, right_img, **kwargs):
        ...
        if self.mono_head is not None:
            ...
            out.append(F.interpolate(1/2 * mono_disp, scale_factor=1/2, mode="bilinear", align_corners=False))
            ...
            out.append(torch.zeros((B,1,H//4,W//4),device=cur_disps.device))
        # 1/16
        ...
        for i in range(self.iters//2):
            ...
            out.append(out[-1] +  self.convex_upsample(cur_disps, mask1, 4))
        ...
        for i in range(self.iters//2):
            ...
            #for cur_disps in cur_disps_list:
            out.append(out[-1] +  self.convex_upsample(cur_disps, mask2, 2))
        ...
        for i in range(self.iters):
            ...
            #for cur_disps in cur_disps_list:
            out.append(out[-1] + cur_disps)

        for i in range(len(out)):
            out[i] = self.convex_upsample(out[i], mask3, 4)        
