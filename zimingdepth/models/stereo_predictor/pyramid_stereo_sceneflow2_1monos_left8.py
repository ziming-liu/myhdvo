...
LastEditTime: 2023-03-27 13:24:01
...
class PyramidStereoSceneFlow2_1MonosLeft8(nn.Module):
    """
    Base depth method. 
    ...
    def __init__(self, backbone, neck, disp_head, mono_head, max_disp, in_channels=128,
      ...
      iters=4, **kwargs):
        ...
        """
        super(PyramidStereoSceneFlow2_1MonosLeft8, self).__init__()
    ...
    def extract_disp(self, left_img, right_img, **kwargs):
        ...
        if self.mono_head is not None:
            ...
            mono_disp = self.mono_head(feats[-1][:B,...]) # 1/4 resolution 
