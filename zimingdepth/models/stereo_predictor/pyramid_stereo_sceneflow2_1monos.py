...
class PyramidStereoSceneFlow2_1Monos(nn.Module):
    """
    Base depth method. 

    """
    def __init__(self, backbone, neck, disp_head, mono_head, in_channels=128, max_disp=256,
      ...
      iters=4, **kwargs):
        ...
        """
        super(PyramidStereoSceneFlow2_1Monos, self).__init__()
    ...
    def extract_disp(self, left_img, right_img, **kwargs):
        ...
        out = [] 
        self.bins_results= []
        mono_disp = self.mono_head(mono_feats[0]) # 1/2 resolution 
...
@STEREO_PREDICTOR.register_module()
class PyramidStereoSceneFlow2_1MonosUnsup(PyramidStereoSceneFlow2_1Monos):
...
@STEREO_PREDICTOR.register_module()
class PyramidStereoSceneFlow2_1Monosv2(PyramidStereoSceneFlow2_1Monos):
