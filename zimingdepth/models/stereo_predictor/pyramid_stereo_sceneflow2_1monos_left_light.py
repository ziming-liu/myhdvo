...
class PyramidStereoSceneFlow2_1MonosLeftLight(nn.Module):
    """
    Base depth method. 
    ...
    def __init__(self, backbone, neck, disp_head, mono_head, max_disp, in_channels=128,
      ...
      iters=4, **kwargs):
        ...
        """
        super(PyramidStereoSceneFlow2_1MonosLeftLight, self).__init__()
    ...
    def extract_disp(self, left_img, right_img, **kwargs):
        ...
        out.append(F.interpolate(4 * mono_disp, scale_factor=4, mode="bilinear", align_corners=False))
        # 1/16
