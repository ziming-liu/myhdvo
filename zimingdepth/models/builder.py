...
from zimingdepth.utils import import_module_error_func
from .registry import BACKBONES, COST_AGGREGATORS, COST_PROCESSORS, DISP_PREDICTORS, HEADS, LOSSES, NECKS, STEREO_PREDICTOR, MASKS, GEOMETRY, MONO_PREDICTOR
...
def build_model(cfg, train_cfg=None, test_cfg=None):
    ...
    raise ValueError(f'{obj_type} is not registered in '
                     'MONO_PREDICTOR, STEREO_PREDICTOR')
